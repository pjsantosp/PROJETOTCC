    ...
    public partial class Criabanco : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.User", t => t.usuarioEnviouId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SolicitacaoPericia", "pacientePessoaId", "dbo.Pessoa");
            DropForeignKey("dbo.SolicitacaoPericia", "medicoPessoaId", "dbo.Pessoa");
            DropForeignKey("dbo.SolicitacaoPericia", "cidId", "dbo.Cid");
            ...
            DropIndex("dbo.SolicitacaoPericia", new[] { "pacientePessoaId" });
            DropIndex("dbo.SolicitacaoPericia", new[] { "cidId" });
            ...
            DropTable("dbo.Cid");
            DropTable("dbo.SolicitacaoPericia");
